...
/**
 * Reprend telle quelle l'expérience de `mise-public/recipe-detail` (dial de portions, coût
 * matière, étapes cochables avec minuteurs) pour que le chef retrouve la même page qu'en
 * cuisine plutôt qu'une simple fiche imprimable — seule l'étiquette (spécifique à mise-public,
 * absente du dashboard) n'a pas d'équivalent ici.
 */
@Component({
