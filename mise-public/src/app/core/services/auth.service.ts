...
import { AuthUser, PublicUser } from '../models/auth.model';
...
export class AuthService {
  ...
  /** Public, unauthenticated — powers the account picker on the login screen. */
  listUsers() {
    return this.http.get<PublicUser[]>(`${this.baseUrl}/users`);
  }
